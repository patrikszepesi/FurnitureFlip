...
//
  ...
  const handleAddLesson = async (e) => {
    ...
    try {
      ...
      // console.log(data)
      setValues({ ...values, chapter:values.chapter, title: "", content: "", video: {}, counter:uuid()});
      setProgress(0);
  ...
  const handleAddChapter = async (e) => {
    ...
    try {
      ...
      setValues({ ...values, chapter:"",title: "", content: "", video: {} });
      setUploadButtonText("Feltöltés");
      setChapterVisible(false);
      setCourse(data);
      toast("fejezet hozzáadva");
    } catch (err) {
      console.log(err);
      toast("Hiba");
    }
          ...
          <div className="container-fluid pt-1">
            ...
            <div className="row">
              <Button
                ...
                size="large"
              >
                Videó hozzáadása a jelenlegi fejezethez
              </Button>
            ...
            <div className="row pb-5">
              <div className="col lesson-list">
                ...
                <Section className={classes.pagePaddingTop}>
                  <Questions data={questions} course={course} />
                    </Section>
                <List
